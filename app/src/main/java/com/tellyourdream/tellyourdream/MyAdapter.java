...
public class MyAdapter extends ArrayAdapter<oldDreams> {

    public MyAdapter(@NonNull Context context, @NonNull List<oldDreams> dreamItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        oldDreams currentDream = getItem(position);
