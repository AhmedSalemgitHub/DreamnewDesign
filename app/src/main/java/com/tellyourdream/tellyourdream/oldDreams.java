...
public class oldDreams {
    ...
    public oldDreams(String owner, String dreamDetails, int age, String maritalStatus, String gender, String dreamTime, String replystatus, String openedstatus, String ownerEmail, String reply, String parentKey) {
        this.owner = owner;
    ...
    public void setValues(oldDreams newDreamItem) {
